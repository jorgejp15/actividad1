...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
             <a class="nav-link" href="/rol_usuario/create">Registrar Rol de Usuario</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container my-5">
    ...
    <tr>
        <td>{{ $rol->Usuario_id }}</td>
        <td>{{ $rol->nombreRol }}</td>
        <td>
        <a href="{{ route('rol_usuario.edit', $rol->Usuario_id) }}">Editar</a>
            <form action="{{ route('rol_usuario.destroy', $rol->Usuario_id) }}" method="POST">
                @csrf
                @method('DELETE')
