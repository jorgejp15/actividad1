...
<body>
    ...
    <form method="POST" action="{{ route('docente.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('salario') is-invalid @enderror" id="salario" name="salario" value="{{ old('salario') }}">
            @error('salario')
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('fecha_de_ingreso') is-invalid @enderror" id="fecha_de_ingreso" name="fecha_de_ingreso" value="{{ old('fecha_de_ingreso') }}">
